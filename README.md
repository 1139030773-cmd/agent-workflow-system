...
| `agent-newbie-guide` | 引导者 | 把模糊想法变成可执行任务 |
| `agent-project-master` | 策划者 | 项目规划、任务拆分、决策闸门 |
| `agent-debug-fixer` | 执行者 | 最小修复，不重构不加功能 |
| `agent-learning-coach` | 执行者 | 讲-练-批改-复习循环 |
| `agent-drift-auditor` | 审计者 | 只读诊断，五级纠错 |
